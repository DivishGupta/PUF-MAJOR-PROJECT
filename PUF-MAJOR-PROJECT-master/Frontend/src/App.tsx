...
export default function App() {
  ...
  // Permanently enforce the correct browser tab title.
  // Uses a MutationObserver to fight back against any external script
  // (e.g. Vite plugin, browser extension) that tries to override it.
  useEffect(() => {
    const TITLE = 'PUF Analyzer | Security Research Platform';
